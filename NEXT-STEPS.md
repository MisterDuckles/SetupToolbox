...
- **v0.8.11** — Polish + milestone v0.8.0 release voorbereiding:
  - Diagnostic logs auto-cleanup (alle `%TEMP%\WingetAppDeployer_*.log` files ouder dan N dagen opruimen)
  - Empty-state UI's voor Deep clean / Leftovers — netter dan alleen InfoBar "nothing to clean"
  - Auto-refresh tussen scans (na delete: opnieuw scannen voor verifie)
  - Versie-bump naar **v0.8.0** als milestone-release zodra v0.8.10 + v0.8.11 af zijn → release op GitHub met exe-artifacts
