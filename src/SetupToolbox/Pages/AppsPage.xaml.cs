...
public sealed partial class AppsPage : Page
{
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        // Welcome-banner (v0.10.1) tonen zolang de user 'm niet heeft weggeklikt.
        var showWelcome = App.Settings.ShowWelcomeBanner;
        WelcomeBanner.Visibility = showWelcome ? Visibility.Visible : Visibility.Collapsed;
        WelcomeBanner.IsOpen = showWelcome;
    }

    private void WelcomeBanner_CloseButtonClick(InfoBar sender, object args)
    {
        App.Settings.ShowWelcomeBanner = false;
